<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mostrar.aspx.cs" Inherits="Clinicaaspnet.mostrar" %>
...
<ul>
<li>
  <label class="titulo" for="nombre">Sangre <span class="requerido">*</span></label>
  <div>
    <span>
     <asp:TextBox ID="Txtnombre" runat="server" Width="186px"></asp:TextBox>
      <label id="lab">ver expedient</label>
    </span>
