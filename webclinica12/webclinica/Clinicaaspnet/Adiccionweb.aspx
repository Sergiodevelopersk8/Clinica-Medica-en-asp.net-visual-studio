<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adiccionweb.aspx.cs" Inherits="Clinicaaspnet.Adiccionweb" %>
...
<ul>
<li>
  <label class="titulo" for="nombre">Adiccion <span class="requerido">*</span></label>
  <div>
    <span>
     <asp:TextBox ID="Txtnombre" runat="server" Width="186px"></asp:TextBox>
      <label id="lab">Tipo de Adiccion</label>
    </span>
